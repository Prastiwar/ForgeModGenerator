...
***Tool to generate common files to make forge mod***
...
Please read [CONTRIBUTING.md](https://github.com/Prastiwar/ForgeModGenerator/blob/master/.github/CONTRIBUTING.md) for details on contributing.
